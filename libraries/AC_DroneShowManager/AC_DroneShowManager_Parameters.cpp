...
const AP_Param::GroupInfo AC_DroneShowManager::var_info[] = {
    ...
    // @Bitmask: 0:Enable velocity control,1:Enable trajectory acceleration
    // @User: Advanced
    ...
    // Parameter indices 60 and 61 are retired. Do not reuse them: deployed
    // aircraft may retain SHOW_ACC_FF_GAIN and SHOW_ACC_FF_MAX in EEPROM.
