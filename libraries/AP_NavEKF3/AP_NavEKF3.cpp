 ...
 * posErr     : legacy scalar and N/E/D 1-sigma position errors (m)
 ...
 *
*/
void NavEKF3::writeExtNavData(const Vector3f &pos, const Quaternion &quat, const ExtNavPositionError &posErr, float angErr, uint32_t timeStamp_ms, uint16_t delay_ms, uint32_t resetTime_ms)
{
